...
class Request_Reply:
        ...
        # def reply(self, update, msg, allow_in_group_chat):
        def reply(self, update, callback, msg, allow_in_group_chat=False):
                ...
                if type(msg) is list:
                        for r in msg:
                                ...
                                # Sticker reply
                                if 'sticker' in r: 
                                        self.n.bot.sendSticker(chat_id=chat_id, sticker=r['sticker'], disable_notification=False)
